 ...
 */
final class Version20210706182355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE books (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, isbn VARCHAR(255) NOT NULL, title LONGTEXT NOT NULL, slug VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, publication_date DATETIME NOT NULL, desktop_cover_image LONGTEXT DEFAULT NULL, mobile_cover_image LONGTEXT DEFAULT NULL, price BIGINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_4A1B2A92CC1CF4E6 (isbn), UNIQUE INDEX UNIQ_4A1B2A92989D9B62 (slug), INDEX IDX_4A1B2A9212469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
